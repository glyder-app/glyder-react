  ...
  render() {
    return (
      <div className="component-Panel">
	  	<button id={"component-Panel_Color_" + this.props.title} style={{backgroundColor:this.props.color}} className="component-Panel_Color" onClick={() => this.props.onClick()}></button>
